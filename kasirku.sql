...
--
-- Host: 127.0.0.1
-- Generation Time: May 29, 2024 at 06:17 AM
...
INSERT INTO `barang` (`id_barang`, `id_kategori`, `barcode`, `nama_barang`, `harga`, `stok`, `foto`, `terjual`, `id_user`) VALUES
(15, 21, 'BRG001', 'Indomie goreng', 29000, 15, 'indomie5.jpg', '', 30),
(16, 21, 'BRG002', 'Sania 2 Liter', 29000, 23, 'sania3.jpg', '', 30),
(18, 21, 'BRG003', 'Mie Sedaap', 3500, 25, 'noodle3.png', '', 30);
...
(4, 'herr@gmail.com', 'biodata.PNG', 35);
...
INSERT INTO `karyawan` (`id_karyawan`, `nama_karyawan`, `no_hp`, `email`, `id_user`) VALUES
(8, 'Budi', '082351911849', 'rigeldonovan@gmail.com', 30);
...
INSERT INTO `pelanggan` (`id_pelanggan`, `nama_pelanggan`, `no_hp`, `alamat`, `id_user`) VALUES
(15, 'Budi', '0813131113', 'Jln Seturan', 30);
...
INSERT INTO `supplier` (`id_supplier`, `nama_supplier`, `alamat`, `no_hp`, `id_user`) VALUES
(11, 'Grosir berkah', 'Jln. Utama Pugeran No 50', '08234829010', 30);
...
INSERT INTO `toko` (`id_toko`, `nama_toko`, `alamat`, `kode_pos`, `id_karyawan`, `id_user`) VALUES
(15, 'Toko Bagas', 'Jln. Pugeran No 50', '55281', 8, 30);
...
INSERT INTO `transaksi` (`id_transaksi`, `id_pelanggan`, `invoice`, `total`, `final_price`, `cash`, `remaining`, `note`, `date`, `created`, `id_user`) VALUES
(15, 15, 'MP2311200001', '120000', 126000, 126000, 0, 'lunas', '2024-01-07', '2024-01-07 14:34:49', 30);
...
('1593819880', 100, 'qris', '2024-05-02 17:2', NULL, NULL, NULL, '201', 35),
...
(30, 'Rigel Donovan', 'rigeldonovan@gmail.com', 'rigel', 'e10adc3949ba59abbe56e057f20f883e', 'Aktif', '2024-05-08 09:14:02'),
...
(34, 'Luis Setiawan', 'luisikhwan@yahoo.co.id', 'luis', 'e6ba4060d7bc5a577715be0c5352a6f1', 'Tidak Aktif', '2024-05-01 08:23:35'),
(35, 'heerrr', 'herr@gmail.com', 'herr', '0d1a2e259a78487dbf7eaf8f9e1fc37f', 'Tidak Aktif', '2024-05-01 08:32:56'),
(36, 'heerrr', 'herr@gmail.com', 'herr', '0d1a2e259a78487dbf7eaf8f9e1fc37f', 'Tidak Aktif', '2024-05-01 08:33:07');
...
--
ALTER TABLE `berlangganan`
  MODIFY `id_berlangganan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `chat`
  ADD CONSTRAINT `chat_ibfk_1` FOREIGN KEY (`id_chatbot`) REFERENCES `chatbot` (`id_chatbot`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Constraints for table `chatbot`
--
ALTER TABLE `chatbot`
  ADD CONSTRAINT `chatbot_ibfk_1` FOREIGN KEY (`id_chatbot`) REFERENCES `chat` (`id_chatbot`) ON DELETE CASCADE ON UPDATE NO ACTION;
